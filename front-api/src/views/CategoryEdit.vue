<template>
  <div class="flex justify-center items-center h-screen">
    <div class="w-3/4">
      ...
      <form @submit.prevent="updateCategory" class="mb-5 bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        <div class="mb-4">
          <label for="name" class="block text-gray-700 text-sm font-bold mb-2">Nom de la catégorie:</label>
          <input id="name" v-model="category.name" required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
        </div>
